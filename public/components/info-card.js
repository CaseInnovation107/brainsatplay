...
function openNav() {
  ...
  .left {
      ...
      <i id="nav-arrow" class="arrow left"></i>
        ...
        <h4>Brains@Play Project Template</h4>
        <p class="small">Created by <a href="https://brainsatplay.com">Brains@Play</a>. See all examples <a href="https://brainsatplay.com/#game-nav">here</a></p>
        <p>Create your own brain-responsive web app.</p>
        <h5>Source</h5>
        <a href="https://github.com/brainsatplay/brainsatplay.github.io/tree/master/docs/examples/template" label="Github">
      ...
      <a href="https://editor.p5js.org/gflynn/sketches/7XhHs2xnX" label="p5 Editor">
